...
const translations = {
  tr: {
    ...
    'feature5Title': 'Mobile Pentest',
    'feature5Text': 'Android ve iOS uygulamalarında derinlemesine güvenlik analizi, API key koruması ve veri sızıntısı testleri.',
    ...
    'successBadge2': 'Web Uygulama Güvenlik Açığı',
    'successTime2': 'Kritik Veri Erişimi Önlendi',
    'successText3': 'Çalıştığımız kurumlardan birisinde var olan Web uygulaması güvenliği sayesinde müşterilerin tüm kimlik bilgilerine erişebildiğimizi keşfettik. Bu kritik güvenlik açığını tespit ettikten hemen sonra kurum yetkililerine detaylı bir rapor sunduk.',
    'successText4': 'Açığın kapatılması ve sistem güvenliğinin sağlanması için kurumla yakın işbirliği içinde çalıştık. Açık tamamen giderilene kadar süreç boyunca ilgilendik ve müşteri verilerinin güvenliğini sağladık.',
    'result5': '✓ Kritik Veri Erişimi Önlendi',
    'result6': '✓ Müşteri Kimlik Bilgileri Korundu',
    'result7': '✓ Açık Kapanana Kadar Takip Edildi',
    'result8': '✓ Sistem Güvenliği Sağlandı',
    'successBadge3': 'Mobil Uygulama API Key Açığı',
    'successTime3': 'Hizmet Sağlayıcı API\'leri Korundu',
    'successText5': 'Mobil uygulamada bulunan bir API key sayesinde hizmet sağlayıcılarının sunduğu API\'leri kullanabildiğimizi ve hizmetlere erişebildiğimizi keşfettik. Bu açığın kötü niyetli kişiler tarafından kullanılması durumunda ciddi maddi ve prestij kayıpları yaşanabilirdi.',
    'successText6': 'Kurum yetkililerini durum hakkında bilgilendirdik ve API key\'in güvenli bir şekilde saklanması ve rotasyonu için öneriler sunduk. Açığın tamamen giderilene kadar takipçisi olduk ve sistemin güvenliğini sağladık.',
    'result9': '✓ API Key Güvenliği Sağlandı',
    'result10': '✓ Hizmet Sağlayıcı API\'leri Korundu',
    'result11': '✓ Potansiyel Maliyet Kaybı Önlendi',
    'result12': '✓ Açık Kapatıldı ve Doğrulandı',
  ...
  en: {
    ...
    'feature5Title': 'Mobile Pentest',
    'feature5Text': 'In-depth security analysis in Android and iOS applications, API key protection, and data leakage tests.',
    ...
    // Success Story
    'successTitle': 'One of Our Success Stories',
    ...
    'successBadge2': 'Web Application Security Vulnerability',
    'successTime2': 'Critical Data Access Prevented',
    'successText3': 'We discovered that due to an existing web application security issue at one of our client companies, we could access all customer identity information. We immediately reported this critical security vulnerability to the company executives with a detailed report.',
    'successText4': 'We worked closely with the company to close the vulnerability and ensure system security. We followed up throughout the process until the vulnerability was completely resolved and ensured the security of customer data.',
    'result5': '✓ Critical Data Access Prevented',
    'result6': '✓ Customer Identity Information Protected',
    'result7': '✓ Followed Until Vulnerability Closed',
    'result8': '✓ System Security Ensured',
    'successBadge3': 'Mobile Application API Key Vulnerability',
    'successTime3': 'Service Provider APIs Protected',
    'successText5': 'We discovered that through an API key found in a mobile application, we could use the APIs provided by service providers and access services. If this vulnerability were exploited by malicious actors, serious financial and prestige losses could occur.',
    'successText6': 'We informed the company executives about the situation and provided recommendations for secure storage and rotation of the API key. We followed up until the vulnerability was completely resolved and ensured system security.',
    'result9': '✓ API Key Security Ensured',
    'result10': '✓ Service Provider APIs Protected',
    'result11': '✓ Potential Cost Loss Prevented',
    'result12': '✓ Vulnerability Closed and Verified',
    ...
    'linkedinCompanyLabel': 'Company LinkedIn',
    'linkedinExpert1Label': 'Azizcan Daştan - LinkedIn',
    'linkedinExpert2Label': 'Özlem Ozan - LinkedIn',
    'websiteLabel': 'Website',
